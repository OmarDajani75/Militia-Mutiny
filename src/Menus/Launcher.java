...
public class Launcher {
    ...
    public Launcher() {
        ...
        this.jf.setTitle("Militia Mutiny"); // setting the title of the JFrame window.
    ...
    private void initUIComponents() {
        ...
        this.mainPanel.add(endPanel, "winner");
        this.mainPanel.add(endPanel, "loser");
    ...
    public static void setWhoWon(String winner) {
        System.out.println("Green tank wins!");
        System.out.println("Blue tank wins!");
    }

    public static void setWhoLost(String loser) {
        System.out.println("Green tank lost!");
        System.out.println("Blue tank lost!");
    }
